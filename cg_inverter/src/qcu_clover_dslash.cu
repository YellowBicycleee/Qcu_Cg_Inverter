...
void CloverDslash::calculateDslash(int dagger_flag) {}
...
void invertCloverDslashHalf (void *fermion_out, void *fermion_in, void *gauge, QcuParam *param, int parity) {
  int Lx = param->lattice_size[0];
  int Ly = param->lattice_size[1];
  int Lz = param->lattice_size[2];
  int Lt = param->lattice_size[3];
...
void callCloverDslashCoalesced(void *fermion_out, void *fermion_in, void *gauge, QcuParam *param, int parity, int dagger_flag) {
  ...
  callWilsonDslashCoalesce(fermion_out, fermion_in, gauge, param, parity,  dagger_flag);
...
void callCloverDslash(void *fermion_out, void *fermion_in, void *gauge, QcuParam *param, int parity, int dagger_flag) {
  ...
  callWilsonDslashNaive(fermion_out, fermion_in, gauge, param, parity, dagger_flag);
  invertCloverDslashHalf (fermion_out, nullptr, gauge, param, parity);
}